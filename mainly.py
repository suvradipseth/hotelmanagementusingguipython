...
class HOTEL_MANAGEMENT:
    def __init__(self):
        ...
        _bgcolor = '#FFA07A'  # X11 color: 'LIGHTSALMON'
        ...
        root.title("HILL TOP HEAVEN RESORT")
        root.configure(background="#FFA07A")
        root.configure(highlightbackground="#FFA07A")
        root.configure(highlightcolor="red")
        ...
        self.Frame1.configure(relief=GROOVE)
        self.Frame1.configure(background="#FFDAB9")
        self.Frame1.configure(highlightbackground="#FFA07A")
        ...
        self.Message6.configure(background="#FFDAB9")
        self.Message6.configure(font=font16)
        self.Message6.configure(foreground="#000000")
        self.Message6.configure(highlightbackground="#FFA07A")
        self.Message6.configure(highlightcolor="red")
        self.Message6.configure(text='''WELCOME to HILL TOP HEAVEN RESORT''')
        self.Message6.configure(width=791)

        self.Button2 = Button(self.Frame1)
        self.Button2.place(relx=0.18, rely=0.17, height=103, width=566)
        self.Button2.configure(activebackground="#FFA07A")
        self.Button2.configure(activeforeground="#000000")
        self.Button2.configure(background="#FFA07A")
        self.Button2.configure(disabledforeground="#bfbfbf")
        self.Button2.configure(font=font14)
        self.Button2.configure(foreground="#000000")
        self.Button2.configure(highlightbackground="#FFA07A")
        ...
        self.Button3.configure(activebackground="#FFA07A")
        self.Button3.configure(activeforeground="#000000")
        self.Button3.configure(background="#FFA07A")
        self.Button3.configure(disabledforeground="#bfbfbf")
        self.Button3.configure(font=font14)
        self.Button3.configure(foreground="#000000")
        self.Button3.configure(highlightbackground="#FFA07A")
        ...
        self.Button4.configure(activebackground="#FFA07A")
        self.Button4.configure(activeforeground="#000000")
        self.Button4.configure(background="#FFA07A")
        self.Button4.configure(disabledforeground="#bfbfbf")
        self.Button4.configure(font=font14)
        self.Button4.configure(foreground="#000000")
        self.Button4.configure(highlightbackground="#FFA07A")
        ...
        self.Button5.configure(activebackground="#FFA07A")
        self.Button5.configure(activeforeground="#000000")
        self.Button5.configure(background="#FFA07A")
        self.Button5.configure(disabledforeground="#bfbfbf")
        self.Button5.configure(font=font14)
        self.Button5.configure(foreground="#000000")
        self.Button5.configure(highlightbackground="#FFA07A")
        ...
        self.Button6.configure(activebackground="#FFA07A")
        self.Button6.configure(activeforeground="#000000")
        self.Button6.configure(background="#FFA07A")
        self.Button6.configure(disabledforeground="#bfbfbf")
        self.Button6.configure(font=font14)
        self.Button6.configure(foreground="#000000")
        self.Button6.configure(highlightbackground="#FFA07A")
